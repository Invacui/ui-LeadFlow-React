...
import { createTemplateSchema, type CreateTemplateFormValues } from '@/schemas/templates.schema';
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={cn('flex flex-col gap-6', className)}>
      <div className="space-y-2">
        ...
        <Input placeholder="e.g. Cold outreach v1" {...register('name')} />
      ...
      <div className="space-y-2">
        ...
        <Input placeholder="e.g. Quick question about {{company}}" {...register('subject')} />
